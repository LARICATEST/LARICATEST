...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./LARICATEST.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S LARICATEST -X kill
screen -S LARICATEST ./LARICATEST
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LARICATESTTEAM/Files_LARICATEST/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1573309498,1573309498,1573309498,1573309498}   
function SudoBot(msg)  
local LARICATEST = false  
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARICATESTW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "IPIPIPl")
...
local LARICATEST_Msg = ''  
if msgs < 100 then 
LARICATEST_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
LARICATEST_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
LARICATEST_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
LARICATEST_Msg = 'متفاعل' 
elseif msgs < 1200 then 
LARICATEST_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
LARICATEST_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
LARICATEST_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
LARICATEST_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
LARICATEST_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
LARICATEST_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
LARICATEST_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
LARICATEST_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
LARICATEST_Msg = 'رب التفاعل'  
end 
return LARICATEST_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLARICATEST(msg,data) -- بداية العمل
if msg then
...
if DevLARICATESTW(msg) then
local bl = ' ❃∫ اهلا عزيزي آلمـطـور\n ❃∫ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ❃∫ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ❃∫ من خلاال الكيبورت خاص بك\n ❃∫ قناة سورس البوت [اضغط هنا](t.me/IPIPIPl)'
local keyboard = {
...
if start then 
SourceLARICATESTr = start
else
SourceLARICATESTr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/IPIPIPl)'
end 
send(msg.chat_id_, msg.id_, SourceLARICATESTr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevLARICATESTW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevLARICATESTW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,LARICATEST_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevLARICATESTW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevLARICATESTW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevLARICATESTW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevLARICATESTW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevLARICATESTW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevLARICATESTW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevLARICATESTW(msg) then 
...
if text == 'تحديث السورس ❃' and DevLARICATESTW(msg) then 
os.execute('rm -rf LARICATEST.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATESTTEAM/LARICATEST/master/LARICATEST.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس لاريكا\n ❃∫ الاصدار » { 1.3v}')
dofile('LARICATEST.lua')  
end
if text == 'الاصدار ❃' and DevLARICATESTW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس لاريكا \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevLARICATESTW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/IPIPIPl) \n ❃∫ [قناه السورس](t.me/IPIPIPl)')
end
if text == "ضع اسم للبوت ❃" and DevLARICATESTW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevLARICATESTW(msg) then 
...
if text == 'المشتركين ❃' and DevLARICATESTW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevLARICATESTW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevLARICATESTW(msg) then
...
if text == ("قائمه العام ❃") and DevLARICATESTW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevLARICATESTW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevLARICATESTW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevLARICATESTW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevLARICATESTW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevLARICATESTW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevLARICATESTW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevLARICATESTW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevLARICATESTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevLARICATESTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local LARICATEST = (w + q)
local sendok = #group - LARICATEST
if q == 0 then
LARICATEST = ''
else
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..LARICATESTk..''..LARICATEST..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevLARICATESTW(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'IPIPIPl')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevLARICATESTW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IPIPIPl')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLARICATESTW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLARICATESTW(msg) then
...
local LARICATEST1_Msg = database:get(bot_id.."LARICATEST1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LARICATEST1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IPIPIPl')..') \n ❃∫ '..LARICATEST1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if LARICATEST_Msg and not Special(msg) then  
local LARICATEST_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LARICATEST_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..LARICATEST_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/IPIPIPl)}\n ❃∫ ["..LARICATEST_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/IPIPIPl)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLARICATESTW(msg) then
...
'\n ❃∫ الرابط {['..LinkGp..']}'
if not DevLARICATESTW(msg) then
sendText(SUDO,Text,0,'md')
end
end
end,nil) 
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLARICATESTW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevLARICATESTW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLARICATESTW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevLARICATESTW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevLARICATESTW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevLARICATESTW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevLARICATESTW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevLARICATESTW(msg) then  
...
database:sadd(bot_id.."LARICATEST:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LARICATEST:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_LARICATEST = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_LARICATEST then 
names_LARICATEST = database:smembers(bot_id.."LARICATEST:blocname"..msg.chat_id_) or ""
if names_LARICATEST and names_LARICATEST[1] then 
for i=1,#names_LARICATEST do 
if name_LARICATEST:match("(.*)("..names_LARICATEST[i]..")(.*)") then 
...
database:set(bot_id.."LARICATEST:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LARICATEST:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LARICATEST:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LARICATEST:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LARICATEST:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_LARICATESTa_new(LARICATEST1,LARICATEST2)
if LARICATEST2 and LARICATEST2.first_name_ then 
if LARICATEST2.first_name_:match("(.*)"..database:get(bot_id.."LARICATEST:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LARICATEST:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local LARICATEST_nnn = database:get(bot_id.."LARICATEST:nump"..msg.chat_id_) or 5
local LARICATEST_nnn2 = database:get(bot_id.."LARICATEST:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(LARICATEST_nnn2) == tonumber(LARICATEST_nnn) or tonumber(LARICATEST_nnn2) > tonumber(LARICATEST_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LARICATEST:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..LARICATEST2.username_.."](https://t.me/"..(LARICATEST2.username_ or "IPIPIPl")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LARICATEST:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(LARICATEST_nnn) - tonumber(LARICATEST_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_LARICATESTa_new)
end
end
...
local LARICATESTChengName = database:get(bot_id.."LARICATEST:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LARICATESTChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LARICATESTChengName..']')
database:del(bot_id.."LARICATEST:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LARICATESTChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LARICATEST:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LARICATESTChengUserName = database:get(bot_id.."LARICATEST:Cheng:UserName"..data.id_)
if not data.username_ then 
if LARICATESTChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LARICATESTChengUserName..']')
database:del(bot_id.."LARICATEST:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LARICATESTChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."LARICATEST:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LARICATESTChengPhoto = database:get(bot_id.."LARICATEST:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LARICATESTChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."LARICATEST:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LARICATESTChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."LARICATEST:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
≪━━━━━━LT━━━━━━≫
 ❃∫ ↬LARICA 𝐓𝐄𝐀𝐌
≪━━━━━━LT━━━━━━≫
 ❃∫ ↬[Channel LARICATEST](t.me/IPIPIPl) 
≪━━━━━━LT━━━━━━≫
 ❃∫ ↬[Information](t.me/IPIPIPl)
≪━━━━━━LT━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/IPIPIPl)
≪━━━━━━LT━━━━━━≫
 ❃∫ ↬[orders LARICATEST](t.me/IPIPIPl)
≪━━━━━━LT━━━━━━≫
 ❃∫ ↬[To talk to us](t.me/IPIPIPl)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevLARICATESTW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IPIPIPl')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'IPIPIPl')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevLARICATESTW(msg) then    
dofile('LARICATEST.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevLARICATESTW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLARICATESTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevLARICATESTW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevLARICATESTW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLARICATESTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevLARICATESTW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevLARICATESTW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLARICATESTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevLARICATESTW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevLARICATESTW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevLARICATESTW(msg) then
...
if text == 'الملفات' and DevLARICATESTW(msg) then
t = ' ❃∫ ملفات السورس لاريكا ↓\n≪━━━━━━LT━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevLARICATESTW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICATESTTEAM/Files_LARICATEST/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات لاريكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━LT━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━LT━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس لاريكا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/IPIPIPl) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevLARICATESTW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LARICATESTTEAM/Files_LARICATEST/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('LARICATEST.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس لاريكا \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevLARICATESTW(msg) then
...
if text == "مسح الملفات" and DevLARICATESTW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLARICATESTW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLARICATESTW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "IPIPIPl")
...
function Function_LARICATEST(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LARICATEST, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_LARICATEST, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IPIPIPl')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IPIPIPl')..')'
...
database:set(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LARICATEST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LARICATEST1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LARICATEST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LARICATEST1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LARICATEST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LARICATEST1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LARICATEST1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LARICATEST1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LARICATEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LARICATEST1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LARICATEST1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━LT━━━━━━≫\n"
for k,v in pairs(list) do  
local LARICATEST_Msg = database:get(bot_id.."LARICATEST1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LARICATEST_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevLARICATESTW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevLARICATESTW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'IPIPIPl')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevLARICATESTW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevLARICATESTW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لاريكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'لاريكا')
local LARICATEST_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..LARICATEST_Msg[math.random(#LARICATEST_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevLARICATESTW(msg) then 
...
},function(ta,LARICATEST)
local t = "\nツ قائمة الاعضاء \n≪━━━━━━LT━━━━━━≫\n"
x = 0
local list = LARICATEST.members_
for k, v in pairs(list) do
x = x + 1
...
if text == ("مسح ردود المطور") and DevLARICATESTW(msg) then 
...
if text == ("ردود المطور") and DevLARICATESTW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━LT━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevLARICATESTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevLARICATESTW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لاريكا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevLARICATESTW(msg) then   
...
if text == 'تعطيل المغادره' and DevLARICATESTW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LARICATEST')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'IPIPIPl')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
LARICATESTdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevLARICATESTW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/LARICATEST.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━LT━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━LT━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/IPIPIPl)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/LARICATEST.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/LARICATEST.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لاريكا')
...
LARICATEST = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LARICATEST)
...
--------------------------------------------------------------------------------------------------------------
SourceLARICATEST(data.message_,data)
...
------------------------------------------------------------------------
local LARICATESTAbot = database:get(bot_id.."LARICATEST1:Add:Filter:Rp2"..text..result.chat_id_)   
if LARICATESTAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..LARICATESTAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local LARICATEST1_Msg = database:get(bot_id.."LARICATEST1:Add:Filter:Rp2"..text..result.chat_id_)   
if LARICATEST1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..LARICATEST1_Msg)
